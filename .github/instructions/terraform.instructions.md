...
- Store sensitive information in a secure manner, such as using a secrets manager or secure parameter store.
  - Regularly rotate credentials and secrets.
  - Automate the rotation of secrets, where possible.
- Use environment variables to reference values stored in secrets managers or parameter stores.
...
- Use identity and access management (IAM) roles and policies to control access to resources.
  - Follow the principle of least privilege when assigning permissions.
- Use network security rules and access control lists to control network access to resources.
...
- Use encryption for sensitive data at rest and in transit.
  - Enable encryption for storage volumes, object storage, and managed databases.
